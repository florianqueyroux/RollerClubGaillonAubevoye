<header>
    ...
    <nav>
        <ul class="nav-items">
            ...
            <li><a class="nav-item" href="<?= $router->get('admin.effectifs.senior') ?>">Effectif Sr</a></li>
            <li><a class="nav-item" href="<?= $router->get('admin.effectifs.junior') ?>">Effectif Jr</a></li>
        </ul>
    </nav>
</header>
